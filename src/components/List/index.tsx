...
const StoryList: FC<StoryListProps> = ( {
  ...
  videoDuration, storyContentStyle, headerBackgroundComponent, ...props
} ) => {
      ...
      <Animated.View style={[ animatedStyles, ListStyles.container ]}>
        ...
        >
          ...
          <Animated.View style={[ contentStyles, ListStyles.content ]} pointerEvents="box-none">
            ...
            />
            <StoryHeader {...props} stories={stories} active={isActive} activeStory={activeStory} />
            <StoryContent stories={stories} active={isActive} activeStory={activeStory} storyContentStyle={storyContentStyle} />
          </Animated.View>
        </Animated.View>
      </Animated.View>
